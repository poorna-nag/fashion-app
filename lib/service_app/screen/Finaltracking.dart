...
// import 'package:royalmart/service_app/model/CancleandRefundmodel.dart';
...
//                                                 fit: BoxFit.cover,
//                                                 image: NetworkImage(
//                                                   ServiceAppConstant.Product_Imageurl1 + item.image,
//                                                 ))),
//                                       ),
//                                       Expanded(
//                                         child: Container(
...
//                                                     child: Expanded(
//                                                       child: Text(
//                                                         item.productName == null ? 'name' : item.productName,
//                                                         maxLines: 2,
//                                                         softWrap: true,
//                                                         style: TextStyle(fontSize: 18, fontWeight: FontWeight.w400, color: Colors.black)
//                                                             .copyWith(fontSize: 14),
...
//                                                   children: <Widget>[
//                                                     Text(
//                                                       item.price == null ? '100' : '\u{20B9} ${calDiscount(item.price, item.userPer)}',
//                                                       style: TextStyle(
...
//                 child: Text(
//                   'Submit !',
//                   style: TextStyle(color: ServiceAppColors.pink, fontSize: 18.0),
//                 ))
//           ],
//         ),
//       ),
...
//     String link = ServiceAppConstant.base_url + "api/order_status.php";
//     var map = new Map<String, dynamic>();
//     map['user_id'] = mobile;
//     map['order_id'] = invoiceno;
//     map['status'] = val;
//     map['note'] = resignofcause.text;
//     map['api_id'] = ServiceAppConstant.Shop_id;
...
//     String link = ServiceAppConstant.base_url + "manage/api/reviews/add";
...
//     map['stars'] = (_ratingController.toStringAsFixed(ServiceAppConstant.val)).toString();
