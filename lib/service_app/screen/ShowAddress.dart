...
//                     onTap: () {
//                       if (widget.valu == "0") {
//                         // Navigator.push(context, MaterialPageRoute(builder: (context) => CheckOutPage(add[index])),);}
//                         Navigator.push(
//                           context,
...
//     final response = await http.post(ServiceAppConstant.base_url + 'manage/api/user_address/delete/', body: map);
...
//                     child: Text(
//                       'ok !',
//                       style: TextStyle(color: ServiceAppColors.success, fontSize: 18.0),
//                     )),
//               ],
//             ),
//           ],
