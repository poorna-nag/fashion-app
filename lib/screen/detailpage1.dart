                ...
                Align(
                  ...
                  child: Padding(
                    ...
                    child: Container(
                      ...
                      child: Text('${FoodAppConstant.foodAppCartItemCount}', style: TextStyle(color: Colors.white, fontSize: 15.0)),
                    ),
                  ),
                )
              ],
                                            ...
                                            child: Container(
                                                ...
                                                Constant.Product_Imageurl+imgUrl,
                                                  fit: BoxFit.fill,
                                                      ...
                                                      CachedNetworkImage(
                                                    fit: BoxFit.fill,
                                                    imageUrl: FoodAppConstant.Product_Imageurl2 + imgList1[index],
...
//                          productName1(),
                                        Padding(
                                          ...
                                          child: Text('${name = item.productName??""}',
                                              style: TextStyle(
                                                color: FoodAppColors.product_title_name,
                                                fontSize: 15,
...
//                                                  print( Constant.totalAmount);
                                                                    ...
                                                                    showLongToast("Please select color and size");
                                                                  }
                                                        ...
                                                        ? InkWell(
                                                            onTap: () {
                                                              if (FoodAppConstant.isLogin) {
                                                                ...
                                                                setState(() {
                                                                  wishflag = false;
                                                                  FoodAppConstant.wishlist++;
                                                                  _countList(FoodAppConstant.wishlist);
...
//                                                  print( Constant.totalAmount);
                                                            ...
                                                            child: Container(
                                                              ...
                                                              height: 33,
                                                              width: 45,
                                                              child: Icon(Icons.favorite_border, size: 30, color: FoodAppColors.pink),
                                                            ),
                                                          )
                                                        : InkWell(
                                                            onTap: () {
                                                            ...
                                                            child: Container(
                                                              ...
                                                              height: 33,
                                                              width: 45,
                                                              child: Icon(Icons.favorite, size: 30, color: FoodAppColors.pink),
                                                            ),
                                                          ),
                                                  ],
                                                )
                                                          ...
                                                          children: <Widget>[
                                                            SizedBox(
                                                              ...
                                                              child: CachedNetworkImage(
                                                                fit: BoxFit.cover,
                                                                imageUrl: FoodAppConstant.Product_Imageurl1 + group![index].img!,
                                        ...
                                        child: Column(
                                          ...
                                          children: <Widget>[
                                            SizedBox(
                                              ...
                                              child: CachedNetworkImage(
                                                fit: BoxFit.cover,
                                                imageUrl: FoodAppConstant.Product_Imageurl + products1[index].img!,
//                                                  =="no-cover.png"? getImage(topProducts[index].productIs):topProducts[index].image,
                                                placeholder: (context, url) => Center(child: CircularProgressIndicator()),
                                                errorWidget: (context, url, error) => new Icon(Icons.error),
                                              ),
  ...
  productName1() {
    ...
    Padding(
      padding: const EdgeInsets.only(top: 10.0, bottom: 5, left: 10),
      child: Text(productdetails[0].productName == null ? productdetails[0].productName!.length.toString() : "sanjar",
          style: TextStyle(
            color: Colors.black,
            fontSize: 15,
            fontWeight: FontWeight.w400,
  ...
  priceold() {
    Padding(
      ...
      child: Text('\u{20B9} $total',
          style:
              TextStyle(fontWeight: FontWeight.w700, fontStyle: FontStyle.italic, color: FoodAppColors.mrp, decoration: TextDecoration.lineThrough)),
    );
  }
    ...
    if (nproducts == null) {
      ...
      dbmanager1.insertStudent(st1).then((id) => {
            setState(() {
              ...
              print(FoodAppConstant.totalAmount);
            })
          });
    }
  }
