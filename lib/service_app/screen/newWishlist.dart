...
//     setState(() {
//       ServiceAppConstant.isLogin = islogin;
//     });
//   }
...
//         ServiceAppConstant.totalAmount = totalamount;
//         ServiceAppConstant.itemcount = prodctlist1.length;
//         ServiceAppConstant.wishlist = prodctlist1.length;
//       });
//     });
//   }
...
//                     Scaffold.of(context).showSnackBar(SnackBar(content: Text(" Product is remove"), duration: Duration(seconds: 1)));
//                   } else {
//                     dbmanager.deleteProducts(item.id);
...
//                                         fit: BoxFit.cover,
//                                         image: NetworkImage(
//                                           ServiceAppConstant.Product_Imageurl + item.pimage,
//                                         ))),
//                               ),
//                               Expanded(
//                                 child: Container(
...
//                                         child: Text(
//                                           item.pname == null ? 'name' : item.pname,
//                                           maxLines: 2,
//                                           softWrap: true,
//                                           style: TextStyle(fontSize: 18, fontWeight: FontWeight.w400, color: Colors.black).copyWith(fontSize: 14),
//                                         ),
//                                       ),
//                                       SizedBox(height: 6),
//                                       Text(
...
//                 child: Text(
//                   "Total",
//                   style: TextStyle(fontWeight: FontWeight.w400, color: Colors.black).copyWith(color: Colors.grey, fontSize: 12),
//                 ),
//               ),
//               Container(
//                 margin: EdgeInsets.only(right: 30),
//                 child: Text(
//                   '\u{20B9} ${ServiceAppConstant.totalAmount}',
//                   style: TextStyle(fontWeight: FontWeight.w400, color: Colors.greenAccent.shade700, fontSize: 14),
//                 ),
//               ),
//             ],
//           ),
...
//       alignment: Alignment.topLeft,
//       child: Text(
//         'Total (${ServiceAppConstant.itemcount}) Items',
...
//     setState(() {
//       ServiceAppConstant.totalAmount = double.parse(totalamount);
//     });
//     return ServiceAppConstant.totalAmount.toStringAsFixed(2).toString();
//   }
