...
import 'package:royalmart/model/usable_wallet_amount.dart';
...
class _CheckOutPageState extends State<CheckOutPage> {
  ...
  Future<void> _gefreedelivery() async {
    final response = await http.get((FoodAppConstant.base_url +
        'api/shipping.php?shop_id=' +
        FoodAppConstant.Shop_id) as Uri);
          ...
          setState(() {
            deliveryfee =
                (double.parse(user1.Fee) + FoodAppConstant.shipingAmount)
                    .toString();
            finalamount = FoodAppConstant.totalAmount + double.parse(user1.Fee);
            twltamount = FoodAppConstant.totalAmount + double.parse(user1.Fee);
          });
        } else {
...
//    String? state=pre!.getString("state");
    ...
    this.setState(() {
      ...
      FoodAppConstant.latitude = double.parse(widget.address.lat.toString());
      FoodAppConstant.longitude = double.parse(widget.address.lng.toString());
...
//              borderRadius: BorderRadius.all(Radius.circular(4)),
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              createAddressText(
                  address1 != null ? address1! + " " + address2! : "address",
                  6),
...
//                                      icon: new Icon(Icons.queue_play_next),
  ...
  Future _getwalletActive() async {
    ...
    final response = await http.post(
        (FoodAppConstant.base_url + 'api/user_active_order.php') as Uri,
        body: map);
...
// String invoicemenual;
  Future _getInvoice1(String paymode) async {
    ...
    final response = await http
        .post((FoodAppConstant.base_url + 'api/order.php') as Uri, body: map);
...
//Wallet For Tiffynox...............................................................................................................
    ...
    print("map---------->${map}");
    final response = await http
        .post((FoodAppConstant.base_url + 'verifyUser.php') as Uri, body: map);
