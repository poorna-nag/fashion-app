import 'package:royalmart/grocery/Web/videoPlay.dart';
...
// import 'package:royalmart/grocery/screen/SearcBlogs.dart';
...
class HomeScreenState extends State<BlogScreen> {
    ...
    getfeature("top", "20").then((usersFromServe) {
      if (this.mounted) {
        setState(() {
          ...
          topProducts!.length > 0 ? flag = false : flag = true;
        });
      }
    });
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        backgroundColor: GroceryAppColors.black,
        title: InkWell(
          onTap: () {
          ...
          : Container(
              child: CustomScrollView(slivers: <Widget>[
                SliverList(
                  ...
                  (context, index) => Column(crossAxisAlignment: CrossAxisAlignment.start, children: <Widget>[
                  ...
                  ? InkWell(
                      onTap: () {
                        pro.youtube!.length > 1
                            ...
                            : Navigator.push(
                                context,
                                MaterialPageRoute(builder: (context) => WebViewClass(pro.title??"", GroceryAppConstant.mainurl + pro.url!)),
                              );
                      },
                      child: Container(
                        height: 250,
                        ...
                        child: url1 != null || !url1.isEmpty
                            ? CachedNetworkImage(
                                fit: BoxFit.fill,
                                imageUrl: pro.youtube!.length > 1 ? url1 : GroceryAppConstant.Product_Imageurl6 + url1,
//                                                  =="no-cover.png"? getImage(topProducts[index].productIs):topProducts[index].image,
              ...
              pro.youtube!.length > 1 ? profile(pro) : Row(),
            ],
          ),
          ...
          children: [
            ...
            Container(
              ...
              child: _PostButton(
                  ...
                  onTap: () {
                    print("share");
                    Share.share(GroceryAppConstant.mainurl + post!.url!);
                  }),
            ),
