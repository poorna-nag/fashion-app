...
class VideoState extends State<VideoSplashScreen> {
  ...
  void checkLogin() async {
    ...
    setState(() {
      cityid == null ? FoodAppConstant.cityid = "" : FoodAppConstant.cityid = cityid;
      FoodAppConstant.pinid = pin!;
      val == null ? FoodAppConstant.isLogin = false : FoodAppConstant.isLogin = val;
      ...
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => VendorCategories(),
        ),
      );
    });
