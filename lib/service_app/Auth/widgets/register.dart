...
//     final response = await http.post(ServiceAppConstant.base_url + 'api/step1.php', body: map);
...
//   Widget form() {
//     return Container(
//       margin: EdgeInsets.only(left: _width / 12.0, right: _width / 12.0, top: _height / 40),
//       child: Form(
//         key: _key1,
//         child: Column(
//           children: <Widget>[
...
//         child: Text('SEND OTP', style: TextStyle(fontSize: _large ? 14 : (_medium ? 12 : 10))),
//       ),
//     );
//   }
