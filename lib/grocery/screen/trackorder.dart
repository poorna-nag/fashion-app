...
class GroceryOrdertrack extends StatefulWidget {
  String idvalue;
  GroceryOrdertrack(this.idvalue);

  @override
  State<GroceryOrdertrack> createState() => _GroceryOrdertrackState();
}

class _GroceryOrdertrackState extends State<GroceryOrdertrack> {
  ...
  void _initializeWebView() {
    ...
    print('Grocery Tracking URL: $trackingUrl');
