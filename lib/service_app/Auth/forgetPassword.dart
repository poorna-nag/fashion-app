...
// import 'package:royalmart/service_app/Auth/Form6.dart';
...
//     pref.setString("mobilef", nameController.text);

//     var map = new Map<String, dynamic>();
//     map['shop_id'] = ServiceAppConstant.Shop_id;
//     map['mobile'] = nameController.text;
//     final response = await http.post((ServiceAppConstant.base_url + 'api/forgot.php') as Uri, body: map);
...
//         Navigator.push(context, MaterialPageRoute(builder: (context) => Form6()));
//       }
//     } else
...
//                   colors: [ServiceAppColors.boxColor1, ServiceAppColors.boxColor2],
//                 ),
//               ),
//             ),
//           ),
...
//             child: Text(
//               "Recover",
//               style: TextStyle(fontWeight: FontWeight.w600, color: ServiceAppColors.boxColor1),
//             ),
//           )
//         ],
//       ),
...
//           gradient: LinearGradient(
//             colors: <Color>[ServiceAppColors.boxColor1, ServiceAppColors.boxColor2],
//           ),
//         ),
...
//             child: Text(
//               "Sign up",
//               style: TextStyle(fontWeight: FontWeight.w800, color: ServiceAppColors.boxColor1, fontSize: _large! ? 19 : (_medium! ? 17 : 15)),
//             ),
//           )
//         ],
//       ),
