                  ...
                  children: <Widget>[
                    Container(
                      ...
                      child: PagewiseListView(
                          ...
                          pageFuture: (pageIndex) => getProductsForPage(
...
//
  ...
  Future<List<Products>> getProductsForPage(
      String categoryId, String startIndex) async {
    final products =
        await DatabaseHelper.getProductsByCategory(categoryId, startIndex);
    return products ?? [];
  }
...
//                                                                              cartvalue++;
  ...
  Widget getSelection(String name) {
    return Container(
      ...
      decoration: BoxDecoration(
          color: Color(0xFFE91E63), borderRadius: BorderRadius.circular(14)),
