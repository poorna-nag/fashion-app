...
//    _employeeList = _getEmployee();
  ...
  Future _getEmployee() async {
    ...
    final response = await http.post(Uri.parse(FoodAppConstant.base_url + 'api/step1.php'), body: map);
      ...
      child: Row(
        ...
        children: <Widget>[
          ...
          GestureDetector(
            ...
            child: Text(
              "Recover",
              style: TextStyle(fontWeight: FontWeight.w600, color: FoodAppColors.boxColor1),
            ),
          )
        ],
      ),
      ...
      child: Row(
        ...
        children: <Widget>[
          ...
          GestureDetector(
            ...
            child: Text(
              "Sign up",
              style: TextStyle(fontWeight: FontWeight.w800, color: FoodAppColors.boxColor1, fontSize: _large! ? 19 : (_medium! ? 17 : 15)),
            ),
          )
        ],
      ),
