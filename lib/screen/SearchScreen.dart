                                      ...
                                      Container(
                                        ...
                                        decoration: BoxDecoration(
                                            ...
                                            image: DecorationImage(
                                                fit: BoxFit.fill,
                                                image: NetworkImage(
                                                  suggestionList[index].img != null
                                                      ? FoodAppConstant.Product_Imageurl + suggestionList[index].img!
                                              ...
                                              Row(
                                                children: <Widget>[
                                                  Padding(
                                                    ...
                                                    child: Text(
                                                        '\u{20B9} ${calDiscount(suggestionList[index].buyPrice??"", suggestionList[index].discount??"")}',
                                                        style: TextStyle(
                                                        ...
                                                        children: <Widget>[
                                                          GestureDetector(
                                                            onTap: () {
                                                              ...
                                                              if (suggestionList[index].count != "1" && int.parse(suggestionList[index].count??"") > 1) {
                                                                setState(() {
//                                                                                _count++;
...
//                                                                                _count++;
                                                                              ...
                                                                              print(int.parse(suggestionList[index].moq??""));
                                                                              int totalquantity =
                                                                                  int.parse(quantity) - int.parse(suggestionList[index].moq??"");
                                                                              suggestionList[index].count = totalquantity.toString();
                                                                            });
                                                                          }
                                                                        },
                                                          ...
                                                          onTap: () {
                                                            if (FoodAppConstant.isLogin) {
                                                              ...
                                                              _addToproducts(
                                                                  ...
                                                                  suggestionList[index].youtube??"",
                                                                  suggestionList[index].mv??"",
                                                                  suggestionList[index].moq??"");
                                                              setState(() {
                                                                suggestionList[index].count = "1";
                                                              });
...
/*
                            suggestionList[index].count=="0"? Container():  Container(
                              ...
                              child: Row(
                                ...
                                children: <Widget>[
                                  Padding(
                                    padding: const EdgeInsets.only(top: 2.0, bottom: 1),
                                    child: Text('\u{20B9} ${int.parse(calDiscount(suggestionList[index].buyPrice,suggestionList[index].discount))*int.parse((suggestionList[index].count))}', style: TextStyle(
