...
//  Note note ;
  ...
  void initState() {
    ...
    catby_productData(catid!.length > 0 ? catid![0] : "0", "0", widget.plist.mv!).then((usersFromServe) {
      setState(() {
                  ...
                  (context, index) => Column(
                    ...
                    children: <Widget>[
                      ...
                      Row(
                        ...
                        children: imgList1.asMap().entries.map<Widget>((entry) {
                          int index = entry.key;
                          ...
                          return Container(
                            ...
                            child: Divider(
                              height: 20,
                              color: _current == index ? Colors.pinkAccent : FoodAppColors.darkGray,
                      ...
                      Container(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            ...
                            Padding(
                              padding: const EdgeInsets.only(top: 2.0, bottom: 1),
                              child: Text('\u{20B9} ${(totalmrp! * _count).toStringAsFixed(FoodAppConstant.val)}',
...
//                                                     totalmrp=mrp * _count;
                                              ...
                                              ScaffoldMessenger.of(context).showSnackBar(
                                                  SnackBar(content: Text(" Products  is not avaliable "), duration: Duration(seconds: 1)));
                                            }
                                          },
                                          child: Icon(
                                            Icons.add,
                        ...
                        children: <Widget>[
                          Padding(
                            ...
                            child: Text(
                              'RELATED PRODUCTS',
                              style:
                                  TextStyle(color: FoodAppColors.product_title_name, fontSize: 17, fontFamily: 'Roboto', fontWeight: FontWeight.bold),
                            ),
                          ),
                          /*Padding(
                                padding: const EdgeInsets.only(
