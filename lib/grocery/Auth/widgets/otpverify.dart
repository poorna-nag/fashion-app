...
class _SignInScreenState extends State<SignInScreen> {
  ...
  Future<List<OtpModal>?> _getEmployeeotp() async {
    ...
    map['mobile'] = mobile;
    final response = await http.post(Uri.parse(GroceryAppConstant.base_url + 'api/step2.php'), body: map);
...
//            .showSnackBar(SnackBar(content: Text('Login Successful')));
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          gradient: LinearGradient(
            colors: <Color>[GroceryAppColors.boxColor1, GroceryAppColors.boxColor2],
          ),
        ),
      ...
      child: Row(
        ...
        children: <Widget>[
          ...
          GestureDetector(
            ...
            child: Text(
              "Sign up",
              style: TextStyle(fontWeight: FontWeight.w800, color: GroceryAppColors.boxColor1, fontSize: _large! ? 19 : (_medium! ? 17 : 15)),
            ),
          )
        ],
      ),
