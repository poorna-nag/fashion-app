...
//   List<ListModel> users = List();
//   List<ListModel> suggestionList = List();
...
//     searchvender("", ServiceAppConstant.rad).then((usersFromServe) {
//       if (this.mounted) {
//         setState(() {
...
//                     onChanged: (string) {
//                       if (string != null) {
//                         searchvender(string, ServiceAppConstant.rad).then((usersFromServe) {
//                           setState(() {
//                             users = usersFromServe;
//                             if (users != null) {
//                               suggestionList = users;
...
//             child: Text(
//               "Select distance ${ServiceAppConstant.rad} km ",
//               style: TextStyle(fontSize: 17),
//             ),
//           ),
//           Slider(
//             value: double.parse(ServiceAppConstant.rad),
//             min: 10,
//             max: 200,
//             divisions: 20,
...
//                 distance = value;
//                 ServiceAppConstant.rad = _currentSliderValue.toStringAsFixed(2).toString();
...
//                                   //Navigator.push(context, MaterialPageRoute(builder: (context) => Sbcategory(suggestionList[index].company,suggestionList[index].mvId,suggestionList[index].cat)),);
//                                 },
//                                 child: Card(
...
//                                                           : NetworkImage(ServiceAppConstant.logo_Image_mv + suggestionList[index].pp)
//                                                       : AssetImage("assets/images/plogo.png"))),
//                                         ),
//                                         Expanded(
//                                           child: Container(
