...
//                       ServiceAppConstant.totalAmount =
//                           ServiceAppConstant.totalAmount -
...
//                                     serviceCartItemCount(ServiceAppConstant
//                                         .serviceAppCartItemCount);
//                                   });
//                                 },
//                                 child: Icon(
...
//                 child: Text(
//                   '\u{20B9} ${ServiceAppConstant.totalAmount.toStringAsFixed(2)}',
//                   style: TextStyle(
...
//           RaisedButton(
//             onPressed: () {
//               if (ServiceAppConstant.serviceAppCartItemCount > 0) {
//                 Navigator.push(
//                   context,
//                   MaterialPageRoute(builder: (context) => AddAddress("0")),
//                 );
//               } else {
//                 showLongToast("Add some services first!...");
//               }
//             },
...
//       alignment: Alignment.topLeft,
//       child: Text(
//         'Total (${ServiceAppConstant.itemcount}) Services',
//         style: CustomTextStyle.textFormFieldBold
