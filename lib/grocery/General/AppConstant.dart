...
class GroceryAppConstant {
  ...
  static const String Shop_id = "2979";
  ...
  static String logo_Image_pcat =
      base_url + "manage/uploads/p_category/"; // Corrected path
  static String logo_Image_category =
      base_url + "manage/uploads/category/"; // Alternative path
