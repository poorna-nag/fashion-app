...
//     map['mobile'] = mobile;
//     final response = await http.post(ServiceAppConstant.base_url + 'api/step2.php', body: map);
...
//         child: Text('VERIFY OTP', style: TextStyle(fontSize: _large ? 14 : (_medium ? 12 : 10))),
//       ),
//     );
//   }
