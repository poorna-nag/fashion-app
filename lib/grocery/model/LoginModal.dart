class loginModal {
  ...
  factory loginModal.fromJson(dynamic json) {
    return loginModal(
        ...
        json['gst'] as String,
        json['prime'] as String,
        json['pincode'] as String,
        json['sex'] as String,
        json['dlocation'] as String,
        json['dlocation'] as String,
        json['membership_name'] as String,
        json['membership_joinBonus'] as String,
        json['membership_joinFee'] as String,
        json['membership_validity'] as String,
        json['membership_description'] as String,
        json['membership_directJoin'] as String,
        json['membership_directJoinAmnt'] as String,
