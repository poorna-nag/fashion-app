...
// import 'package:royalmart/service_app/dbhelper/wishlistdart.dart';
...
// import 'package:royalmart/service_app/screen/Zoomimage.dart';
...
//             catby_productData(catid.length > 0 ? catid[0] : "0", "0", productdetails[0].mv??"").then((usersFromServe) {
//               setState(() {
...
//     return Scaffold(
//       backgroundColor: ServiceAppColors.tela1,
//       appBar: AppBar(
//         elevation: 0.0,
...
//                       ),
//                       child: Text('${ServiceAppConstant.serviceAppCartItemCount}', style: TextStyle(color: Colors.white, fontSize: 15.0)),
//                     ),
//                   ),
//                 )
//               ],
...
//                                                 CachedNetworkImage(
//                                               fit: BoxFit.fill,
//                                               imageUrl: ServiceAppConstant.Product_Imageurl2 + imgList1[index],
...
//                                               style: TextStyle(
//                                                 color: ServiceAppColors.product_title_name,
//                                                 fontSize: 15,
...
//                                             ),
//                                             Expanded(
//                                               child: item.productScale!.length < 2
//                                                   ? Container()
//                                                   : Container(
//                                                       width: 120,
//                                                       child: DropdownButton(
...
//                                                                     content: Text(" Products  is not avaliable "), duration: Duration(seconds: 1)));
//                                                               }
//                                                             },
//                                                             child: Icon(
//                                                               Icons.add,
...
//                                                                       ScaffoldMessenger.of(context).showSnackBar(SnackBar(
//                                                                           content: Text(" Products  is added to cart "),
...
//                                                                 setState(() {
//                                                                   wishflag = false;
//                                                                   ServiceAppConstant.wishlist++;
//                                                                   _countList(ServiceAppConstant.wishlist);
...
//                                                               height: 33,
//                                                               width: 45,
//                                                               child: Icon(Icons.favorite_border, size: 30, color: ServiceAppColors.pink),
//                                                             ),
//                                                           )
//                                                         : InkWell(
//                                                             onTap: () {
...
//                                                               height: 33,
//                                                               width: 45,
//                                                               child: Icon(Icons.favorite, size: 30, color: ServiceAppColors.pink),
//                                                             ),
//                                                           ),
//                                                   ],
//                                                 )
...
//                                                   child: Icon(showdis ? Icons.keyboard_arrow_up : Icons.keyboard_arrow_down,
...
//                                                                 fit: BoxFit.cover,
//                                                                 imageUrl: ServiceAppConstant.Product_Imageurl1 + group[index].img!,
...
//                             child: Text(
//                               'RELATED PRODUCTS',
//                               style: TextStyle(color: Colors.black, fontSize: 17, fontFamily: 'Roboto', fontWeight: FontWeight.bold),
//                             ),
//                           ),
//                           // Padding(
//                           //   padding: const EdgeInsets.only(
...
//                                               child: CachedNetworkImage(
//                                                 fit: BoxFit.cover,
//                                                 imageUrl: ServiceAppConstant.Product_Imageurl + products1[index].img!,
// //                                                  =="no-cover.png"? getImage(topProducts[index].productIs):topProducts[index].image,
//                                                 placeholder: (context, url) => Center(child: CircularProgressIndicator()),
//                                                 errorWidget: (context, url, error) => new Icon(Icons.error),
//                                               ),
...
//       padding: const EdgeInsets.only(top: 10.0, bottom: 5, left: 10),
//       child:
//        Text(productdetails[0].productName! == null ? productdetails[0].productName!.length : "sanjar",
//           style: TextStyle(
//             color: Colors.black,
//             fontSize: 15,
//             fontWeight: FontWeight.w400,
...
//       child: Text('\u{20B9} $total',
//           style: TextStyle(
//               fontWeight: FontWeight.w700, fontStyle: FontStyle.italic, color: ServiceAppColors.mrp, decoration: TextDecoration.lineThrough)),
//     );
//   }
...
//       dbmanager.insertStudent(st).then((id) => {print('Student Added to Db ${id}')});
//     }
//   }
...
//               print(ServiceAppConstant.totalAmount);
//             })
//           });
//     }
//   }
