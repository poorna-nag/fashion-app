...
// import 'package:royalmart/service_app/model/UserUpdateModel.dart';
...
//     this.setState(() {
//       nameController.text = ServiceAppConstant.name;
//       emailController.text = ServiceAppConstant.email;
...
//     try {
//       final response = await http.post(ServiceAppConstant.base_url + 'api/ppupload.php', body: map);
...
//         setState(() {
//           ServiceAppConstant.image = user.img;
//           ServiceAppConstant.check = true;
//         });
//         print(user.img);
//       } else
...
//     final response = await http.post(ServiceAppConstant.base_url + 'manage/api/customers/update', body: map);
//     if (response.statusCode == 200) {
...
//     String imagevalue1 = (imageshow1).toString();
//     if (imagevalue1 != null) {
//       imagevalue = imagevalue1 != null ? imagevalue1.substring(7, (imagevalue1.lastIndexOf('') - 1)).trim() : imagevalue1;
