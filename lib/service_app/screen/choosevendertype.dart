...
//             style: TextStyle(color: ServiceAppColors.white, fontSize: 18, fontFamily: 'Roboto', fontWeight: FontWeight.bold)),
//       ),
...
//                           child: Text("Search ", style: TextStyle(color: ServiceAppColors.white)
//                               // Navigator.push(context, MaterialPageRoute(builder: (context) => ServiceApp()),);
//                               ),
//                         ),
//                       ],
...
//               child: Text("Normal Delivery", style: TextStyle(color: ServiceAppColors.black)),
//             ),
//           ],
//         ),
//       ),
...
//     final response = await http.get((ServiceAppConstant.base_url + 'api/searchLoc.php?shop_id=' + ServiceAppConstant.Shop_id + "&loc=" + id) as Uri);
...
//           ServiceAppConstant.cityid = idval;
