  ...
  void initState() {
    ...
    getShopD().then((usersFromServe1) {
      setState(() {
        ...
        FoodAppConstant.contact = sliderlist!.mobileNo??"";
      });
    });
  }
                                ...
                                children: <Widget>[
                                  ...
                                  Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: <Widget>[
                                        Text(
                                          sliderlist!.address??"" + " " + sliderlist!.city.toString(),
                                          maxLines: 2,
                                          overflow: TextOverflow.fade,
                                        ),
                                      ],
                                        ...
                                        children: <Widget>[
                                          new Column(
                                            ...
                                            children: <Widget>[
                                              Center(
                                                child: new Text(
                                                  "Pincode " + sliderlist!.pincode.toString(),
                                                ),
                                              ),
                                            ],
                                          ),
                                        ...
                                        children: <Widget>[
                                          new Column(
                                            ...
                                            children: <Widget>[
                                              Center(
                                                child: new Text(
                                                  "Mobile: " + sliderlist!.mobileNo.toString(),
                                                ),
                                              ),
                                            ],
                                          ),
...
//        print(user.name);
  ...
  Future _AddAddress() async {
    ...
    String link = "${FoodAppConstant.base_url}/manage/api/contacts/add";
    print(link);
