...
// import 'package:royalmart/service_app/screen/Finaltracking.dart';
// import 'package:royalmart/service_app/screen/trackorder.dart';
...
//                                       item.id,
//                                       style: CustomTextStyle.textFormFieldMedium
//                                           .copyWith(fontSize: 18, color: Colors.deepOrangeAccent, fontWeight: FontWeight.w600),
//                                     ),
//                                   ],
//                                 ),
//                                 SizedBox(
...
//                                       child: Text(
//                                         "Status",
//                                         style: CustomTextStyle.textFormFieldSemiBold.copyWith(fontSize: 15, color: Colors.black54),
//                                       ),
//                                     ),
//                                     Padding(
//                                       padding: EdgeInsets.only(top: 5),
//                                       child: Text(
//                                         item.states,
//                                         style: CustomTextStyle.textFormFieldSemiBold.copyWith(fontSize: 15, color: Colors.deepOrangeAccent),
//                                       ),
//                                     ),
//                                   ],
//                                 ),
