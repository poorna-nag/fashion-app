...
import 'package:royalmart/map/availabledrivers.dart';
...
class GeoFireAssitance{
  ...
  static void removeNearbydriver(String key){
    int index=listofnearbyavailabledrivers.indexWhere((element) => element.key==key);
    listofnearbyavailabledrivers.removeAt(index);
  }
  static void updateNearbydriver(NearbyAvailableDrivers drivers){
    int index=listofnearbyavailabledrivers.indexWhere((element) => element.key==drivers.key);
