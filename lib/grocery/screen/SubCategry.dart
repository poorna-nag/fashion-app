...
//                                                                                                     : '$_count',
//                                                                                                 style: TextStyle(color: GroceryAppColors.tela, fontSize: 15, fontFamily: 'Roboto', fontWeight: FontWeight.bold)),
//                                                                                           ),
//                                                                                         ),
//                                                                                         Container(
...
//                                                     3,
//                                                 child: Text(
//                                                   '( ${GroceryAppConstant.groceryAppCartItemCount} ) items count',
//                                                   style: TextStyle(
//                                                       fontSize: 12,
//                                                       fontWeight:
//                                                           FontWeight.w600,
